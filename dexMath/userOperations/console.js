...
function testWithdraw() {
    r_ = withdraw(1000 * 1e18, 0, 18, 6, slippage, fee, totalSupplyShares, colReservesOne);
    console.log(r_.shares, r_.sharesWithSlippage, r_.success);
    r_ = withdraw(0, 1000 * 1e6, 18, 6, slippage, fee, totalSupplyShares, colReservesOne);
    console.log(r_.shares, r_.sharesWithSlippage, r_.success);
}
// testWithdraw();
...
function testBorrow() {
    r_ = borrow(1000 * 1e18, 0, 18, 6, slippage, fee, totalBorrowShares, debtReservesOne);
    console.log(r_.shares, r_.sharesWithSlippage, r_.success);
    r_ = borrow(0, 1000 * 1e6, 18, 6, slippage, fee, totalBorrowShares, debtReservesOne);
    console.log(r_.shares, r_.sharesWithSlippage, r_.success);
    r_ = borrow(1000 * 1e18, 999 * 1e6, 18, 6, slippage, fee, totalBorrowShares, debtReservesOne);
    console.log(r_.shares, r_.sharesWithSlippage, r_.success);
}
// testBorrow();
