...
function swapIn(
    ...
    const amountOut = swapInAdjusted(swap0To1, amountInAdjusted, colReserves, debtReserves, outDecimals, currentLimits, syncTime);
...
function swapOut(
    ...
    const amountIn = swapOutAdjusted(swap0To1, amountOutAdjusted, colReserves, debtReserves, outDecimals, currentLimits, syncTime);
